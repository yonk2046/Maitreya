...
| # | 事項 | 期限 |
|---|---|---|
| A7 | 畫面黃金名單改讀快照 `obs_golden_*`(目前畫面用全歷史重算,與快照不同) | 10/5 前較佳 |
...
**進行中**:10 年語料(2016-01~2026-09)抓取中,依 `_research/multiyear/PREREGISTRATION.md` 測 H1(法人持續買超)、
H2(中期動能)、H3(交集),判準與停止規則已**事前寫死**。結果自動寫入 `_research/multiyear/PREREG_RESULT.txt`。
**若三個假設都不通過 → 停止尋找選股 alpha,系統定位改為觀察與紀律工具。**
